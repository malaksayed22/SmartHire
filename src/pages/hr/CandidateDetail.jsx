    ...
    return (
      <div style={{ display: "flex", height: "100vh", background: "var(--bg)" }}>
        ...
        >
          ...
          <Link to="/hr/candidates" className="btn btn-primary">
            ← Back to candidates
          </Link>
        </main>
      </div>
        ...
        <div style={{ display: "flex", gap: 0, flex: 1, overflow: "hidden" }}>
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: 12, color: "var(--m2)", marginTop: 4 }}>
                out of 100
              </div>
              <div
                style={{
                    ...
                    >
                      ...
                      >
                        ...
                        <div style={{ textAlign: "right" }}>
                          <span
                            className={`pill pill-${getScoreColor(candidate.score) === "teal" ? "teal" : getScoreColor(candidate.score) === "amber" ? "amber" : "red"}`}
                            style={{ fontSize: 13 }}
                          >
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: 14, color: "var(--m1)" }}>
                          {candidate.education}
                        </div>
                      </div>
                    </div>
